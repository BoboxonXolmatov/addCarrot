...
const Testimionals = () => {
  return (
    <section className="bg-stone-50 px-8 py-20" id="reviews">
      ...
      tracking-tighter">What Client say</h2>
      <div className="container mx-auto flex flex-wrap gap-8">
        {TESTIMONIALS.map((testimonial, index) => (
            <div key={index} className={`rounded-3xl p-4 ${testimonial.bgColor}
            ${testimonial.textColor} flex min-w-[250px] flex-1 flex-col items-center`}>
